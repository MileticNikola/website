<?php
$pageData['title'] = "Team Spectralis | Team";
$pageData['meta']['description'] = "This is our team.";
$pageData['meta']['keywords'] = "team, roster, pros, professional, staff";
$pageData['og']['title'] = "Team Spectralis | Team";
$pageData['og']['description'] = "This is our team.";
        ...
        <?php
            ...
            foreach ($roles as $role) {
                ...
                foreach ($members as $member) {
                    ...
                    echo '<a href="/member/' . $member["username"] . '" class="social"><i class="fas fa-user fa-lg icon-link-special"></i></a>';
                    echo "</div>";
                }
                echo "</div>";
            }
